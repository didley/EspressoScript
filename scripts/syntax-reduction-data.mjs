...
export const REDUCTION_DATA = [
    ...
    },
    {
        ...
        forms: 'if/else · switch · ternary ?: · && short-circuit · || default · ?? nullish · ??= · &&= logical assign',
        permitted: 'if/else (no-else-return) · switch (no-fallthrough)',
        rules: ['no-else-return', 'no-ternary', 'no-and-shorthand', 'no-logical-assignment'],
        ts: 9,
        ss: 2,
    },
    {
        ...
        forms: 'for (counted) · for (;;) infinite · for-in · for-of · for await...of · while · do-while · break · continue · labelled break/continue',
        permitted: 'for (counted) · for-of · for await...of · while · break · continue',
        rules: ['no-infinite-for', 'no-for-in', 'no-do-while', 'no-labels'],
        ts: 10,
        ss: 6,
    },
    {
    ...
    },
    {
        id: 'module-syntax',
        label: 'Module syntax',
        forms: 'require() · static import · import type · export type · import * as ns · dynamic import()',
        permitted: 'static import · import type · export type',
        rules: ['no-require', 'no-namespace-import', 'no-dynamic-import'],
        ts: 6,
        ss: 3,
    },
    {
    ...
    },
    {
        ...
        forms: 'class · constructor · this · extends · abstract · decorators · new (user types) · get · set · #field · static · override',
        permitted: 'none — all banned',
    ...
    },
    {
        ...
        forms: '?. property · ?. method call · ?. index',
        permitted: 'none — use explicit null checks',
    ...
    },
    {
        id: 'destructuring',
        label: 'Destructuring',
        forms: 'array destructure · object destructure · nested destructure · rename binding · default in destructure',
        permitted: 'array · object · nested · rename',
        rules: ['no-default-in-destructure'],
        ts: 5,
        ss: 4,
    },
    {
        id: 'spread-rest',
        label: 'Spread & rest',
        forms: 'array spread [...] · object spread {...} · rest parameters',
        permitted: 'array spread · object spread · rest parameters',
        rules: [],
        ts: 3,
        ss: 3,
    },
    {
        ...
        forms: 'shorthand property · computed property key',
        permitted: 'shorthand property',
        rules: ['no-computed-property-key'],
        ts: 2,
        ss: 1,
    },
    {
        id: 'runtime-operators',
        label: 'Runtime operators',
        forms: 'typeof · instanceof · in · void',
        permitted: 'typeof',
        rules: ['no-instanceof', 'no-in-operator', 'no-void'],
        ts: 4,
        ss: 1,
    },
    {
    ...
    },
    {
        id: 'enum',
        label: 'Enum',
        forms: 'const enum · regular enum',
        permitted: 'none — use union of string literals',
        rules: ['no-enum'],
        ts: 2,
        ss: 0,
    },
    {
        id: 'namespace',
        label: 'Namespace',
        forms: 'namespace · module (TS)',
        permitted: 'none — use ES modules',
        rules: ['no-namespace'],
        ts: 2,
        ss: 0,
    },
    {
        ...
        forms: 'readonly · as const · satisfies',
        permitted: 'readonly',
        rules: ['no-as-const', 'no-satisfies'],
        ts: 3,
        ss: 1,
    },
    {
        ...
        forms: 'string · number · boolean · bigint · symbol · any',
        permitted: 'string · number · boolean',
        rules: ['no-bigint', 'no-symbol', 'no-explicit-any'],
        ts: 6,
        ss: 3,
    },
    {
        id: 'array-types',
        label: 'Array types',
        forms: 'T[] · Array<T> · ReadonlyArray<T> · readonly T[]',
        permitted: 'T[] · ReadonlyArray<T>',
        rules: ['no-array-generic-syntax', 'prefer-readonly-array'],
        ts: 4,
        ss: 2,
    },
    {
        id: 'utility-types',
        label: 'Utility types',
        forms: 'Partial · Required · Readonly · Pick · Omit · Record',
        permitted: 'Readonly',
        rules: ['no-partial', 'no-required', 'no-pick', 'no-omit', 'no-record-utility'],
        ts: 6,
        ss: 1,
    },
    {
        ...
        forms: 'tag`string`',
        permitted: 'none — use explicit function calls',
        rules: ['no-tagged-template-literal'],
        ts: 1,
        ss: 0,
    },
    {
        id: 'generators',
        label: 'Generators',
        forms: 'function* · yield',
        permitted: 'none — use async/await',
        rules: ['no-generators'],
        ts: 2,
        ss: 0,
    },
    {
        id: 'tuple-types',
        label: 'Tuple types',
        forms: '[T, U] · labeled tuple [x: T, y: U]',
        permitted: '[T, U] · labeled tuple',
        rules: [],
        ts: 2,
        ss: 2,
    },
    {
        id: 'type-predicate',
        label: 'Type predicate',
        forms: 'is T · asserts T',
        permitted: 'is T',
        rules: ['no-asserts-predicate'],
        ts: 2,
        ss: 1,
    },
    {
        id: 'misc-operators',
        label: 'Miscellaneous operators',
        forms: 'comma operator · sparse array · empty object type {} · lone block',
        permitted: 'none — all banned',
        rules: ['no-comma-operator', 'no-sparse-arrays', 'no-empty-object-type', 'no-lone-blocks'],
        ts: 4,
        ss: 0,
    },
]
...
export const SYNTAX_FEATURES = [
    ...
    // ── Optional chaining ─────────────────────────────────────────────────────
    { syntax: 'obj?.prop', name: 'optional property', category: 'Optional chaining', allowed: false, replacedBy: 'explicit null check' },
    { syntax: 'obj?.()', name: 'optional call', category: 'Optional chaining', allowed: false, replacedBy: 'explicit null check' },
    { syntax: 'arr?.[0]', name: 'optional index', category: 'Optional chaining', allowed: false, replacedBy: 'explicit null check' },
    // ── Destructuring ─────────────────────────────────────────────────────────
    { syntax: 'const { a } = obj', name: 'object destructure', category: 'Destructuring', allowed: true, replacedBy: null },
    { syntax: 'const [a] = arr', name: 'array destructure', category: 'Destructuring', allowed: true, replacedBy: null },
    { syntax: 'const { a: b } = obj', name: 'rename destructure', category: 'Destructuring', allowed: true, replacedBy: null },
    { syntax: 'const { a, ...r } = obj', name: 'rest destructure', category: 'Destructuring', allowed: true, replacedBy: null },
    { syntax: 'const { a = x } = obj', name: 'default destructure', category: 'Destructuring', allowed: false, replacedBy: 'explicit null check after destructure' },
    // ── Spread & rest ─────────────────────────────────────────────────────────
    { syntax: '...args', name: 'rest parameter', category: 'Spread & rest', allowed: true, replacedBy: null },
    { syntax: 'f(...arr)', name: 'spread in call', category: 'Spread & rest', allowed: true, replacedBy: null },
    { syntax: '[...a, ...b]', name: 'array spread', category: 'Spread & rest', allowed: true, replacedBy: null },
    // ── Object literal forms ──────────────────────────────────────────────────
    { syntax: '{ x }', name: 'shorthand property', category: 'Object literals', allowed: true, replacedBy: null },
    { syntax: '{ [key]: val }', name: 'computed property', category: 'Object literals', allowed: false, replacedBy: '{ key: val } with explicit key' },
    // ── Switch ───────────────────────────────────────────────────────────────
    { syntax: 'switch (x) {}', name: 'switch', category: 'Conditional branching', allowed: true, replacedBy: null },
    // ── Logical assignment additions ──────────────────────────────────────────
    { syntax: 'x &&= y', name: '&&= assign', category: 'Conditional branching', allowed: false, replacedBy: 'if / else' },
    { syntax: 'x ||= y', name: '||= assign', category: 'Conditional branching', allowed: false, replacedBy: 'if / else' },
    // ── Loop control ─────────────────────────────────────────────────────────
    { syntax: 'break', name: 'break', category: 'Loop constructs', allowed: true, replacedBy: null },
    { syntax: 'continue', name: 'continue', category: 'Loop constructs', allowed: true, replacedBy: null },
    { syntax: 'for await (x of xs)', name: 'for await...of', category: 'Loop constructs', allowed: true, replacedBy: null },
    // ── Runtime operators ─────────────────────────────────────────────────────
    { syntax: 'typeof x', name: 'typeof', category: 'Runtime operators', allowed: true, replacedBy: null },
    { syntax: 'x instanceof C', name: 'instanceof', category: 'Runtime operators', allowed: false, replacedBy: 'explicit type check' },
    { syntax: 'k in obj', name: 'in operator', category: 'Runtime operators', allowed: false, replacedBy: 'Object.hasOwn()' },
    { syntax: 'void x', name: 'void operator', category: 'Runtime operators', allowed: false, replacedBy: null },
    // ── Bitwise operators ─────────────────────────────────────────────────────
    { syntax: 'a & b', name: 'bitwise AND', category: 'Bitwise operators', allowed: false, replacedBy: null },
    { syntax: 'a | b', name: 'bitwise OR', category: 'Bitwise operators', allowed: false, replacedBy: null },
    { syntax: 'a ^ b', name: 'bitwise XOR', category: 'Bitwise operators', allowed: false, replacedBy: null },
    { syntax: '~a', name: 'bitwise NOT', category: 'Bitwise operators', allowed: false, replacedBy: null },
    { syntax: 'a << b', name: 'left shift', category: 'Bitwise operators', allowed: false, replacedBy: null },
    { syntax: 'a >> b', name: 'right shift', category: 'Bitwise operators', allowed: false, replacedBy: null },
    { syntax: 'a >>> b', name: 'unsigned right shift', category: 'Bitwise operators', allowed: false, replacedBy: null },
    // ── Enum ─────────────────────────────────────────────────────────────────
    { syntax: 'enum E {}', name: 'enum', category: 'Enum', allowed: false, replacedBy: 'union type' },
    { syntax: 'const enum E {}', name: 'const enum', category: 'Enum', allowed: false, replacedBy: 'union type' },
    // ── Namespace ────────────────────────────────────────────────────────────
    { syntax: 'namespace Foo {}', name: 'namespace', category: 'Namespace', allowed: false, replacedBy: 'ES modules' },
    { syntax: 'module Foo {}', name: 'internal module', category: 'Namespace', allowed: false, replacedBy: 'ES modules' },
    // ── Type modifiers ────────────────────────────────────────────────────────
    { syntax: 'readonly prop', name: 'readonly', category: 'Type modifiers', allowed: true, replacedBy: null },
    { syntax: 'x satisfies T', name: 'satisfies', category: 'Type modifiers', allowed: false, replacedBy: null },
    { syntax: 'x as const', name: 'as const', category: 'Type modifiers', allowed: false, replacedBy: 'explicit typed const' },
    // ── Primitive types ───────────────────────────────────────────────────────
    { syntax: 'any', name: 'any', category: 'Primitive types', allowed: false, replacedBy: 'unknown' },
    { syntax: 'unknown', name: 'unknown', category: 'Primitive types', allowed: true, replacedBy: null },
    { syntax: 'never', name: 'never', category: 'Primitive types', allowed: true, replacedBy: null },
    { syntax: 'void', name: 'void (type)', category: 'Primitive types', allowed: false, replacedBy: null },
    { syntax: 'null', name: 'null (type)', category: 'Primitive types', allowed: true, replacedBy: null },
    { syntax: 'undefined', name: 'undefined (type)', category: 'Primitive types', allowed: false, replacedBy: 'T | null' },
    // ── Array types ───────────────────────────────────────────────────────────
    { syntax: 'T[]', name: 'array type', category: 'Array types', allowed: true, replacedBy: null },
    { syntax: 'Array<T>', name: 'Array<T> generic', category: 'Array types', allowed: false, replacedBy: 'T[]' },
    { syntax: 'readonly T[]', name: 'readonly array', category: 'Array types', allowed: true, replacedBy: null },
    { syntax: 'ReadonlyArray<T>', name: 'ReadonlyArray<T>', category: 'Array types', allowed: false, replacedBy: 'readonly T[]' },
    // ── Type-only imports / exports ───────────────────────────────────────────
    { syntax: 'import type { T }', name: 'type import', category: 'Module syntax', allowed: true, replacedBy: null },
    { syntax: 'export type { T }', name: 'type export', category: 'Module syntax', allowed: true, replacedBy: null },
    { syntax: 'import * as ns', name: 'namespace import', category: 'Module syntax', allowed: false, replacedBy: 'named imports' },
    // ── OOP additions ─────────────────────────────────────────────────────────
    { syntax: 'get prop()', name: 'getter', category: 'OOP constructs', allowed: false, replacedBy: 'plain function' },
    { syntax: 'set prop(v)', name: 'setter', category: 'OOP constructs', allowed: false, replacedBy: 'plain function' },
    { syntax: '#field', name: 'private field', category: 'OOP constructs', allowed: false, replacedBy: null },
    { syntax: 'static member', name: 'static', category: 'OOP constructs', allowed: false, replacedBy: 'module-level const' },
    { syntax: 'override', name: 'override', category: 'OOP constructs', allowed: false, replacedBy: null },
    // ── Tagged templates ──────────────────────────────────────────────────────
    { syntax: 'tag`str`', name: 'tagged template', category: 'Tagged templates', allowed: false, replacedBy: null },
    // ── Generators & async generators ────────────────────────────────────────
    { syntax: 'yield', name: 'yield', category: 'Generators', allowed: false, replacedBy: null },
    { syntax: 'async function*()', name: 'async generator', category: 'Generators', allowed: false, replacedBy: null },
    // ── Tuple types ───────────────────────────────────────────────────────────
    { syntax: '[A, B]', name: 'tuple type', category: 'Tuple types', allowed: true, replacedBy: null },
    { syntax: '[name: A, age: B]', name: 'named tuple', category: 'Tuple types', allowed: true, replacedBy: null },
    // ── Type predicate ────────────────────────────────────────────────────────
    { syntax: 'x is T', name: 'type predicate', category: 'Type predicate', allowed: true, replacedBy: null },
    { syntax: 'asserts x is T', name: 'assertion predicate', category: 'Type predicate', allowed: false, replacedBy: null },
    // ── Advanced type additions ───────────────────────────────────────────────
    { syntax: 'keyof T', name: 'keyof', category: 'Advanced types', allowed: false, replacedBy: null },
    { syntax: 'typeof x (type)', name: 'typeof (type)', category: 'Advanced types', allowed: false, replacedBy: null },
    { syntax: 'T[K]', name: 'indexed access', category: 'Advanced types', allowed: false, replacedBy: null },
    // ── Utility types ─────────────────────────────────────────────────────────
    { syntax: 'Partial<T>', name: 'Partial<T>', category: 'Utility types', allowed: false, replacedBy: 'explicit type with | null' },
    { syntax: 'Required<T>', name: 'Required<T>', category: 'Utility types', allowed: false, replacedBy: 'explicit type' },
    { syntax: 'Readonly<T>', name: 'Readonly<T>', category: 'Utility types', allowed: false, replacedBy: 'readonly on each field' },
    { syntax: 'Record<K, V>', name: 'Record<K,V>', category: 'Utility types', allowed: true, replacedBy: null },
    { syntax: 'Pick<T, K>', name: 'Pick<T,K>', category: 'Utility types', allowed: false, replacedBy: 'explicit type' },
    { syntax: 'Omit<T, K>', name: 'Omit<T,K>', category: 'Utility types', allowed: false, replacedBy: 'explicit type' },
    // ── Misc operators ────────────────────────────────────────────────────────
    { syntax: '(a, b)', name: 'comma operator', category: 'Misc operators', allowed: false, replacedBy: null },
    { syntax: '[1,,3]', name: 'sparse array', category: 'Misc operators', allowed: false, replacedBy: '[1, undefined, 3]' },
    { syntax: '{}', name: 'empty object type', category: 'Misc operators', allowed: false, replacedBy: 'Record<string, unknown>' },
    { syntax: '{ /* lone */ }', name: 'lone block', category: 'Misc operators', allowed: false, replacedBy: null },
]
